...
1. Read the applicable workflow skill files: `.github/skills/context-discovery/SKILL.md`, `.github/skills/automated-ux-audit/SKILL.md`, `.github/skills/team-handoff/SKILL.md`, `.github/skills/webapp-testing/SKILL.md`
...
## Prototype Tester Framework (from "Design Prompt Framework: Senior UX Designer Guide")

...
**2. Design Direction** — apply this agent's visual design guidance and relevant design-system skills:
...
## Dashboard Designer Framework (from "Design Prompt Framework: Senior UX Designer Guide")

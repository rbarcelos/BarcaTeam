...
1. Read the applicable workflow skill files: `.github/skills/context-discovery/SKILL.md`, `.github/skills/security-audit/SKILL.md`, `.github/skills/team-handoff/SKILL.md`

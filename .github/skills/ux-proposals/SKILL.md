---
name: ux-proposals
description: Multi-subagent UX exploration cycle with parallel proposals, PM consolidation, peer review, and a production-ready HTML mock deliverable.
---

# UX Proposals

Multi-subagent UX exploration cycle. Parallel proposals from diverse perspectives, PM consolidation, peer review, and a production-ready HTML mock as the final deliverable.
...
PHASE 1: SCOPE & CAST              (Lead — 1 turn)
   ↓
PHASE 2: PARALLEL PROPOSALS         (N subagents — concurrent)
   ↓
...
The lead analyzes the goal and selects 2-5 Copilot subagents from this roster based on what the goal touches:

| Signal in Goal | Copilot Subagent Types to Consider |
|---|---|
...
**Deliverable:** Write to reviews/ux-proposals/{sprint-name}/{subagent_type}-proposal.md
...
All subagents run **concurrently**. No subagent sees another's proposal.
...
Each original proposal subagent reviews the consolidated proposal:
...
**Output:** `reviews/ux-proposals/{sprint-name}/{subagent_type}-review.md`
...
reviews/ux-proposals/{sprint-name}/
  roster.md                          # Phase 1
  {subagent_type}-proposal.md           # Phase 2 (one per agent)
  consolidated-proposal.md           # Phase 3
  {subagent_type}-review.md             # Phase 4 (one per agent)

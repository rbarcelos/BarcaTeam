---
name: security-audit
description: Structured security review for the full application stack, covering attack surface, secrets, injection, auth, data handling, dependencies, and headers.
---

# Security Audit

Structured security review for the full application stack. Used by the `security-reviewer` Copilot subagent or `/security-review`.

## Trigger

Used by Copilot subagents with `security-audit` in their skills list, or when `/security-review` or a security review is requested.

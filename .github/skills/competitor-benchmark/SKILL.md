...
description: Structured competitive intelligence gathering and analysis for STR investment tools.
---
...
1. **Web search** for: `{competitor} features`, `{competitor} pricing`, `{competitor} reviews`
2. **Fetch** their marketing pages, pricing pages, help docs
3. **Web search** for user reviews: `{competitor} review site:biggerpockets.com`, `{competitor} reddit`
4. Document:

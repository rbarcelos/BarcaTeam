---
name: issue-triage
description: PM-driven triage over the last 50 open GitHub issues on a repo, with Copilot subagent technical assessment, labels, comments, closures, and a triage summary.
---

# Issue Triage Skill

The PM chairs triage. The lead coordinates Copilot subagents as needed; PM drives the final outcome.
...
### Step 2 — Pre-sort
PM classifies each issue before invoking subagents:
...
For each non-trivial issue, PM asks the lead to invoke the relevant Copilot subagent with the issue context:
...
Wait for subagent responses before applying the outcome.

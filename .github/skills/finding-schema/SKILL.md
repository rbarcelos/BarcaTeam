---
name: finding-schema
description: Canonical schema for all agent-generated findings.
---
...
Machine-readable schema copy: `finding.yaml` (also referenced as `.github/skills/finding-schema/finding.yaml`).

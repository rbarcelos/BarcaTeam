...
Standard protocol for agents to ask the user questions. Follow this format every time you need to ask the user a question.
...
- **One question at a time.** Never batch multiple decisions into one user-question request.

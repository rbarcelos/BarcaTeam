...
## Tooling priority
1. **Context7 MCP** (preferred). If a context7 MCP server is connected and exposes a tool like `resolve-library-id` + `get-library-docs`, USE THAT FIRST. Returns version-pinned snippets straight into context.

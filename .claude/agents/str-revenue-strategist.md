...
1. Read the applicable workflow skill files: `.github/skills/context-discovery/SKILL.md`, `.github/skills/document-templates/SKILL.md`, `.github/skills/issue-templates/SKILL.md`, `.github/skills/team-handoff/SKILL.md`
